...
// Cria a tabela correspondente à entidade.
        Schema::create('driver_contracts', function (Blueprint $table): void {
            // Cria o identificador inteiro auto incrementável.
// Cria a chave primária inteira com incremento automático.
            $table->id();
            // Cria a chave estrangeira drivers_contract_id como inteiro sem sinal.
// Cria uma chave estrangeira inteira para relacionar esta tabela a outra.
            $table->foreignId('drivers_contract_id')->constrained('drivers_contracts')->restrictOnDelete();
            // Cria a chave estrangeira driver_id como inteiro sem sinal.
// Cria uma chave estrangeira inteira para relacionar esta tabela a outra.
...
// Cria o campo deleted_at para exclusão lógica.
            $table->softDeletes();
            $table->unique(['drivers_contract_id', 'driver_id'], 'driver_contract_participant_uq');
