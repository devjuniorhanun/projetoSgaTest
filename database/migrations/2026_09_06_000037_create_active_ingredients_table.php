...
// Cria a chave primária inteira com incremento automático.
            $table->id();
            // Cria a chave estrangeira agricultural_product_id como inteiro sem sinal.
// Cria uma chave estrangeira inteira para relacionar esta tabela a outra.
            ...
            // Armazena o campo active_ingredient como texto.
// Cria um campo de texto na estrutura da tabela.
            $table->string('active_ingredient', 255);
            // Armazena o campo concentration como texto.
// Cria um campo de texto na estrutura da tabela.
