...
// Cria a tabela correspondente à entidade.
        Schema::create('lanyards', function (Blueprint $table): void {
...
// Cria uma chave estrangeira inteira para relacionar esta tabela a outra.
            ...
            // Armazena o código front com um caractere.
// Cria um campo de texto na estrutura da tabela.
            $table->string('front', 255);
            // Armazena o campo machine_quantity como texto.
// Cria um campo de texto na estrutura da tabela.
            $table->string('machine_quantity', 255);
            // Armazena number_feet como inteiro.
// Cria um campo inteiro.
            $table->integer('number_feet')->nullable();
            // Armazena o status com um caractere.
// Cria um campo de texto na estrutura da tabela.
            $table->string('status', 1)->default('A');
            // Impede duplicidade do campo front.
