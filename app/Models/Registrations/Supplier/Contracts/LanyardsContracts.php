...
// Define explicitamente o nome da tabela utilizada pelo Eloquent.
    protected $table = 'lanyards_contracts';
...
// Define o item atual da coleção ou configuração.
        'closing_date',
        // Permite o preenchimento do campo body.
// Define o item atual da coleção ou configuração.
        'body',
        'remuneration_percentage', 'calculation_basis', 'bag_weight', 'fuel_supplied_by',
        'meal_allowance_description', 'observations', 'producer_snapshot', 'supplier_snapshot',
        'participants_snapshot', 'bank_snapshot', 'contract_snapshot', 'pdf_path', 'pdf_hash',
...
// Retorna o resultado da operação atual.
        return [
            'remuneration_percentage' => 'decimal:4', 'bag_weight' => 'decimal:3',
...
// Abre o bloco de código atual.
    {
// Retorna o resultado da operação atual.
        return $this->hasMany(LanyardContract::class);
// Fecha o bloco de código atual.
    }
