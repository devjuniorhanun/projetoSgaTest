...
use App\Http\Requests\Registrations\Supplier\TypeSupplierRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Supplier\TypeSupplierResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Supplier\TypeSupplier;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Supplier\TypeSupplierService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe TypeSupplierController.
...
// Declara o método responsável por esta operação.
    public function __construct(private TypeSupplierService $service)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return TypeSupplierResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new TypeSupplierResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return new TypeSupplierResource($typeSupplier);
// Fecha o bloco de código atual.
    }

    // Atualiza um registro existente.
// Declara o método responsável por esta operação.
    public function update(TypeSupplierRequest $request, TypeSupplier $typeSupplier)
// Abre o bloco de código atual.
    {
        // Atualiza pelo serviço usando somente dados validados.
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($typeSupplier, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new TypeSupplierResource($item);
// Fecha o bloco de código atual.
    }
...
// Executa uma operação utilizando uma dependência ou propriedade da classe.
        $this->service->delete($typeSupplier);
