...
use App\Http\Requests\Registrations\Supplier\WarehouseRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Supplier\WarehouseResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Supplier\Warehouse;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Supplier\WarehouseService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe WarehouseController.
...
// Retorna o resultado da operação atual.
        return WarehouseResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new WarehouseResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
