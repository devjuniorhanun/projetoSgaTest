...
use App\Http\Requests\Registrations\Supplier\DriverRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Supplier\DriverResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Supplier\Driver;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Supplier\DriverService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe DriverController.
...
// Retorna o resultado da operação atual.
        return DriverResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new DriverResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($driver, $request->validated());
