...
use App\Http\Requests\Registrations\Supplier\BankSupplierRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Supplier\BankSupplierResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Supplier\BankSupplier;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Supplier\BankSupplierService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe BankSupplierController.
...
// Declara o método responsável por esta operação.
    public function __construct(private BankSupplierService $service)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return BankSupplierResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }

    // Cria um novo registro a partir de um payload validado.
// Declara o método responsável por esta operação.
    public function store(BankSupplierRequest $request)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return (new BankSupplierResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }

    // Exibe um registro específico.
// Declara o método responsável por esta operação.
    public function show(BankSupplier $bankSupplier)
// Abre o bloco de código atual.
    {
        // Retorna o registro transformado pelo Resource.
// Retorna o resultado da operação atual.
        return new BankSupplierResource($bankSupplier);
// Fecha o bloco de código atual.
    }

    // Atualiza um registro existente.
// Declara o método responsável por esta operação.
    public function update(BankSupplierRequest $request, BankSupplier $bankSupplier)
// Abre o bloco de código atual.
    {
        // Atualiza pelo serviço usando somente dados validados.
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($bankSupplier, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new BankSupplierResource($item);
// Fecha o bloco de código atual.
    }

    // Exclui logicamente o registro.
// Declara o método responsável por esta operação.
    public function destroy(BankSupplier $bankSupplier)
// Abre o bloco de código atual.
    {
        // Executa o soft delete pelo serviço.
// Executa uma operação utilizando uma dependência ou propriedade da classe.
        $this->service->delete($bankSupplier);
