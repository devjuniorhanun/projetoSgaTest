...
use App\Http\Requests\Registrations\Financial\CostCenterRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Financial\CostCenterResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Financial\CostCenter;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Financial\CostCenterService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe CostCenterController.
...
// Retorna o resultado da operação atual.
        return CostCenterResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new CostCenterResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($costCenter, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new CostCenterResource($item);
// Fecha o bloco de código atual.
    }
