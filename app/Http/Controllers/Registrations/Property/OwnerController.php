...
use App\Http\Requests\Registrations\Harvest\Property\OwnerRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Harvest\Property\OwnerResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Property\Owner;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Harvest\Property\OwnerService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe OwnerController.
...
// Retorna o resultado da operação atual.
        return OwnerResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new OwnerResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($owner, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new OwnerResource($item);
// Fecha o bloco de código atual.
    }
