...
use App\Http\Requests\Registrations\Property\Areas\FieldRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Property\Areas\FieldResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Property\Areas\Field;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Property\Areas\FieldService;
// Importa uma dependência utilizada neste arquivo.
...
// Retorna o resultado da operação atual.
        return (new FieldResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($field, $request->validated());
