...
namespace App\Http\Controllers\Registrations\Property;

// Importa uma dependência utilizada neste arquivo.
use App\Http\Requests\Registrations\Harvest\Property\ProducerRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Harvest\Property\ProducerResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Property\Producer;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Harvest\Property\ProducerService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe ProducerController.
...
// Declara o método responsável por esta operação.
    public function __construct(private ProducerService $service)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return ProducerResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new ProducerResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($producer, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new ProducerResource($item);
// Fecha o bloco de código atual.
    }
