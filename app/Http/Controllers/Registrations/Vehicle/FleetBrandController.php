...
use App\Http\Requests\Registrations\Vehicle\FleetBrandRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Vehicle\FleetBrandResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Vehicle\FleetBrand;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Vehicle\FleetBrandService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe FleetBrandController.
...
// Declara o método responsável por esta operação.
    public function __construct(private FleetBrandService $service)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return FleetBrandResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }

    // Cria um novo registro a partir de um payload validado.
// Declara o método responsável por esta operação.
    public function store(FleetBrandRequest $request)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return (new FleetBrandResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }

    // Exibe um registro específico.
// Declara o método responsável por esta operação.
    public function show(FleetBrand $fleetBrand)
// Abre o bloco de código atual.
    {
        // Retorna o registro transformado pelo Resource.
// Retorna o resultado da operação atual.
        return new FleetBrandResource($fleetBrand);
// Fecha o bloco de código atual.
    }

    // Atualiza um registro existente.
// Declara o método responsável por esta operação.
    public function update(FleetBrandRequest $request, FleetBrand $fleetBrand)
// Abre o bloco de código atual.
    {
        // Atualiza pelo serviço usando somente dados validados.
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($fleetBrand, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new FleetBrandResource($item);
// Fecha o bloco de código atual.
    }

    // Exclui logicamente o registro.
// Declara o método responsável por esta operação.
    public function destroy(FleetBrand $fleetBrand)
// Abre o bloco de código atual.
    {
        // Executa o soft delete pelo serviço.
// Executa uma operação utilizando uma dependência ou propriedade da classe.
        $this->service->delete($fleetBrand);
