...
use App\Http\Requests\Registrations\Product\SupplierProductRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Product\SupplierProductResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Product\SupplierProduct;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Product\SupplierProductService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe SupplierProductController.
...
// Declara o método responsável por esta operação.
    public function __construct(private SupplierProductService $service)
// Abre o bloco de código atual.
    {
...
// Retorna o resultado da operação atual.
        return SupplierProductResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new SupplierProductResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($supplierProduct, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new SupplierProductResource($item);
// Fecha o bloco de código atual.
    }
