...
use App\Http\Requests\Registrations\Agricultural\Defensive\TypeOperationRequest;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Resources\Registrations\Agricultural\Defensive\TypeOperationResource;
// Importa uma dependência utilizada neste arquivo.
use App\Models\Registrations\Agricultural\Defensive\TypeOperation;
// Importa uma dependência utilizada neste arquivo.
use App\Services\Registrations\Agricultural\Defensive\TypeOperationService;
// Importa uma dependência utilizada neste arquivo.
use App\Http\Controllers\Controller;

/**
 * Classe TypeOperationController.
...
// Retorna o resultado da operação atual.
        return TypeOperationResource::collection($this->service->list());
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return (new TypeOperationResource($item))->response()->setStatusCode(201);
// Fecha o bloco de código atual.
    }
...
// Retorna o resultado da operação atual.
        return new TypeOperationResource($typeOperation);
// Fecha o bloco de código atual.
    }
...
// Obtém somente os dados aprovados pelas regras de validação.
        $item = $this->service->update($typeOperation, $request->validated());

        // Retorna o registro atualizado.
// Retorna o resultado da operação atual.
        return new TypeOperationResource($item);
// Fecha o bloco de código atual.
    }
...
// Executa uma operação utilizando uma dependência ou propriedade da classe.
        $this->service->delete($typeOperation);
