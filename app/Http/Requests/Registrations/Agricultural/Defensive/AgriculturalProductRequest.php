...
/**
 * Classe AgriculturalProductRequest.
 * Esta classe foi documentada para facilitar a manutenção do projeto.
 */
// Declara a classe responsável por esta parte do domínio.
class AgriculturalProductRequest extends FormRequest
...
// Exige que o campo seja informado.
            ...
            // Valida o campo conforme as regras de negócio.
// Exige que o campo seja informado.
            'type_formulation_id' => ['required', 'integer', 'exists:type_formulations,id'],
            'status' => ['sometimes', Rule::in(['A', 'I'])],
            'active_ingredient' => ['required', 'array', 'min:1'],
            'active_ingredient.*' => ['required', 'array'],
            'active_ingredient.*.active_ingredient' => ['required', 'string', 'max:255'],
            'active_ingredient.*.concentration' => ['required', 'string', 'max:255'],
...
// Define este campo ou configuração na estrutura atual.
            ...
            'active_ingredient' => 'ingredientes ativos',
            'active_ingredient.*.active_ingredient' => 'ingrediente ativo',
            'active_ingredient.*.concentration' => 'concentração',
