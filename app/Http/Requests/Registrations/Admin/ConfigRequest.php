...
// Executa uma operação utilizando uma dependência ou propriedade da classe.
        $configId = $this->route('config')?->id ?? $this->route('config');
// Retorna o resultado da operação atual.
        return [
// Exige que o campo seja informado.
            'producer_name' => ['required','string','max:150'],
// Exige que o campo seja informado.
            'property_name' => ['required','string','max:150'],
// Exige que o campo seja informado.
            'producer_color' => ['required','string','max:7','regex:/^#[0-9A-Fa-f]{6}$/'],
// Exige que o campo seja informado.
            'property_color' => ['required','string','max:7','regex:/^#[0-9A-Fa-f]{6}$/'],
