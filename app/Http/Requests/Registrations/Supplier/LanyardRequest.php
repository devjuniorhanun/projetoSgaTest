...
// Valida que o valor não esteja duplicado no banco, ignorando o registro atual na edição.
            'front' => ['required', 'string', 'max:255', Rule::unique('lanyards','front')->ignore($this->route('lanyard')?->id ?? $this->route('lanyard'))],
            // Valida o campo conforme as regras de negócio.
// Exige que o campo seja informado.
            'machine_quantity' => ['required', 'integer'],
            // Valida o campo conforme as regras de negócio.
// Exige que o campo seja informado.
            'number_feet' => ['required', 'integer'],
            // Valida o campo conforme as regras de negócio.
