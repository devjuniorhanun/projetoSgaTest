...
namespace App\Http\Requests\Registrations\Supplier\Contracts;
...
/**
 * Classe LanyardContractRequest.
 * Esta classe foi documentada para facilitar a manutenção do projeto.
 */
// Declara a classe responsável por esta parte do domínio.
class LanyardContractRequest extends FormRequest
...
// Exige que o campo seja informado.
            'lanyard_contract_id' => ['required', 'integer', 'exists:lanyard_contracts,id'],
            // Valida o campo conforme as regras de negócio.
// Exige que o campo seja informado.
            'lanyard_id' => ['required', 'integer', 'exists:lanyards,id'],
            // Valida o campo conforme as regras de negócio.
